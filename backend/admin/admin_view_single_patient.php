...
<!DOCTYPE html>
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            {
                $mysqlDateTime = $row->pat_date_create;
            ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title"><?php echo $row->pat_prenom;?> <?php echo $row->pat_nom;?>'s Profile</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-left mt-3">
                                        ...
                                        <p class="font-weight-normal"><strong>Full Name :</strong> <span class="ml-2"><?php echo $row->pat_prenom;?> <?php echo $row->pat_nom;?></span></p>
                                        <p class="font-weight-normal"><strong>Mobile :</strong><span class="ml-2"><?php echo $row->pat_phone;?></span></p>
                                        <p class="font-weight-normal"><strong>Address :</strong> <span class="ml-2"><?php echo $row->pat_addr;?></span></p>
                                        <p class="font-weight-normal"><strong>Date Of Birth :</strong> <span class="ml-2"><?php echo $row->pat_daten;?></span></p>
                                        <p class="font-weight-normal"><strong>Age :</strong> <span class="ml-2"><?php echo $row->pat_age;?> Years</span></p>
                                        <p class="font-weight-normal"><strong>Sexe :</strong> <span class="ml-2"><?php echo $row->pat_sexe;?></span></p>
                                        <hr>
                                        <p class="font-weight-normal"><strong>Date Recorded :</strong> <span class="ml-2"><?php echo date("d/m/Y - h:m", strtotime($mysqlDateTime));?></span></p>
                                        <hr>
