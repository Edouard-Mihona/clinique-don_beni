    ...
    if(isset($_POST['admin_login']))
    {
        ...
        if($rs)
            ...
            #echo "<script>alert('Access Denied Please Check Your Credentials');</script>";
                $err = "Access refused Please Check Your Credentials";
            }
    }
?>
<!--End Login-->
...
<head>
        <meta charset="utf-8" />
        <title>Clinic Donbeni System -A Super Responsive Information System</title>
        ...
        <link href="assets/css/app.mi.css" rel="stylesheet" type="text/css" />
                        ...
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <a href="index.php">
                                        <span><img src="assets/images/donb.jpg" alt="" height="150"></span>
                                    </a>
                                ...
                                <form method='post' >
                                    ...
                                    <div class="form-group mb-0 text-center">
                                        <button class="btn btn-info btn-block" name="admin_login" type="submit"> Admin Log In </button>
                                    </div>
