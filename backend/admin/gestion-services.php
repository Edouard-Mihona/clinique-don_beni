                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <th data-hide="phone">Mise a jour</th>
                                        ...
                                        <th data-hide="phone">Action</th>
                                            ...
                                            /*
                                                ...
                                                *
                                            */
                                                $ret="SELECT * FROM prix_service ORDER BY RAND() "; 
                        ...
                        <td><?php echo $row->description;?> </td>
                                    <td><?php echo $row->prix;?> <?php echo $aff;?></td>
                                    <td><?php echo $row->date_update;?></td>
                                                    
                                                    
                                                    <td><a href="update-service.php?service_id=<?php echo $row->id_service;?>" class="badge badge-primary"><i class="mdi mdi-check-box-outline "></i> update</a></td>
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
