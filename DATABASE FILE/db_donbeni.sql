...
--
-- Hôte : 127.0.0.1
-- Généré le :  sam. 25 mai 2024 à 21:20
...
--
-- Déchargement des données de la table `laboratory`
--
...
CREATE TABLE `mode_paiement` (
  ...
  `description_mod` varchar(250) DEFAULT NULL,
...
INSERT INTO `mode_paiement` (`id_mode_paiement`, `description_mod`, `type`, `statu`, `date_create`, `date_update`) VALUES
(1, 'TPO', 'ONG', 1, '2024-04-27 17:21:30', '2024-04-27 17:21:30'),
(2, 'Famille Doris', 'personnel', 1, '2024-04-27 17:21:37', '2024-04-27 17:21:37'),
(3, 'Credit', 'dette', 1, '2024-04-27 17:21:55', '2024-04-27 17:21:55'),
(4, 'Cash', 'cash', 1, '2024-04-27 17:22:05', '2024-04-27 17:22:05');

-- --------------------------------------------------------

--
-- Structure de la table `paiement_service`
--

CREATE TABLE `paiement_service` (
  `id_paiement_service` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `paiement_service`
--

INSERT INTO `paiement_service` (`id_paiement_service`, `id_service`, `pat_id`, `idtaux`, `id_mode_paiement`, `statu`, `etat`, `id_user`, `date_create`, `date_update`) VALUES
(1, 1, 1, 1, 4, 1, 1, 1, '2024-05-18 20:52:13', '2024-04-27 17:24:16'),
(2, 2, 2, 1, 4, 1, 1, 1, '2024-05-18 21:16:07', '2024-04-27 19:03:20'),
(3, 2, 1, 1, 4, 1, 1, 1, '2024-05-02 20:01:02', '2024-04-27 19:17:11'),
(4, 1, 1, 1, 4, 1, 1, 1, '2024-05-18 21:12:20', '2024-05-15 19:56:40'),
(5, 2, 1, 1, 4, 1, 1, 1, '2024-05-18 21:12:20', '2024-05-15 19:57:05'),
(6, 1, 1, 1, 4, 1, 1, 1, '2024-05-18 19:38:46', '2024-05-18 19:30:06'),
(7, 1, 2, 1, 4, 1, 1, 1, '2024-05-18 21:18:27', '2024-05-18 21:16:52'),
(8, 2, 2, 1, 4, 1, 1, 1, '2024-05-18 21:18:27', '2024-05-18 21:17:07'),
(9, 1, 2, 1, 4, 1, 1, 1, '2024-05-18 21:18:27', '2024-05-18 21:17:17'),
(10, 1, 2, 1, 4, 1, 1, 1, '2024-05-18 21:18:27', '2024-05-18 21:17:25'),
(11, 1, 1, 1, 4, 1, 1, 1, '2024-05-18 21:18:51', '2024-05-18 21:17:59'),
(12, 2, 1, 1, 4, 1, 1, 1, '2024-05-18 21:18:40', '2024-05-18 21:18:06'),
(13, 1, 2, 1, 4, 1, 1, 1, '2024-05-19 05:48:49', '2024-05-18 21:26:33'),
(14, 1, 2, 1, 4, 1, 1, 1, '2024-05-19 05:49:52', '2024-05-19 05:49:26');
...
CREATE TABLE `patients` (
  `pat_id` int(20) NOT NULL,
  `pat_nom` varchar(200) DEFAULT NULL,
  `pat_postnom` varchar(200) DEFAULT NULL,
  `pat_prenom` varchar(200) DEFAULT NULL,
  `pat_sexe` varchar(2) DEFAULT NULL,
  `pat_emploi` varchar(200) DEFAULT NULL,
  `pat_age` varchar(200) DEFAULT NULL,
  `pat_daten` varchar(200) DEFAULT NULL,
  `pat_number` varchar(200) DEFAULT NULL,
  `pat_addr` text,
  `pat_phone` varchar(200) DEFAULT NULL,
  `pat_date_create` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  `pat_date_update` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  `id_user` varchar(200) DEFAULT NULL,
  `pat_etat` int(11) NOT NULL DEFAULT '0',
  `pat_statu` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `patients` (`pat_id`, `pat_nom`, `pat_postnom`, `pat_prenom`, `pat_sexe`, `pat_emploi`, `pat_age`, `pat_daten`, `pat_number`, `pat_addr`, `pat_phone`, `pat_date_create`, `pat_date_update`, `id_user`, `pat_etat`, `pat_statu`) VALUES
(1, 'edouard', 'weteshi', 'mihona', 'M', 'sans emploi', '30', '2024-04-04', 'W8LYD', 'nguba', '0995791097', '2024-04-19 20:07:03.783716', '2024-04-19 20:10:16.000000', NULL, 0, 0),
(2, 'faida', 'mushengezi', 'lucette', 'F', 'sans emploi', '20', '2023-09-13', 'RBLGJ', 'nguba', '0995791097', '2024-04-19 20:11:14.000000', '2024-04-19 20:11:14.000000', NULL, 0, 0);

-- --------------------------------------------------------

--
-- Structure de la table `patient_transfers`
--
...
--
-- Déchargement des données de la table `patient_transfers`
--
...
--
-- Structure de la table `pharmaceuticals`
--
...
--
-- Déchargement des données de la table `pharmaceuticals`
--
...
--
-- Structure de la table `pharmaceuticals_categories`
--
...
CREATE TABLE `prix_service` (
  ...
  `type_money` varchar(20) DEFAULT NULL,
  `statu` int(11) NOT NULL DEFAULT '1',
  `date_create` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `date_update` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Déchargement des données de la table `prix_service`
--

INSERT INTO `prix_service` (`id_service`, `description`, `prix`, `type_money`, `statu`, `date_create`, `date_update`) VALUES
(1, 'consultation generale', 14, 'usd', 1, '2024-05-15 20:16:09', '2024-05-15 20:16:09'),
(2, 'attestation', 10000, 'fc', 1, '2024-04-27 19:06:06', '2024-04-27 17:08:40');
...
INSERT INTO `taux_echange` (`idtaux`, `fc`, `statu`, `date_update`) VALUES
(1, 20000, 1, '2024-04-27 17:08:07');
...
--
-- Déchargement des données de la table `vitals`
--
...
--
-- Index pour la table `paiement_service`
--
ALTER TABLE `paiement_service`
  ADD PRIMARY KEY (`id_paiement_service`);
...
--
-- Index pour la table `patient_transfers`
--
...
--
-- Index pour la table `pharmaceuticals`
--
ALTER TABLE `pharmaceuticals`
  ADD PRIMARY KEY (`phar_id`);

--
-- Index pour la table `pharmaceuticals_categories`
--
...
--
-- Index pour la table `prix_service`
--
ALTER TABLE `prix_service`
  ADD PRIMARY KEY (`id_service`);

--
-- Index pour la table `pwdresets`
--
...
--
ALTER TABLE `mode_paiement`
  MODIFY `id_mode_paiement` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `paiement_service`
--
ALTER TABLE `paiement_service`
  MODIFY `id_paiement_service` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
-- AUTO_INCREMENT pour la table `patient_transfers`
--
ALTER TABLE `patient_transfers`
...
--
-- AUTO_INCREMENT pour la table `pharmaceuticals`
--
ALTER TABLE `pharmaceuticals`
  MODIFY `phar_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `pharmaceuticals_categories`
--
ALTER TABLE `pharmaceuticals_categories`
...
--
-- AUTO_INCREMENT pour la table `prix_service`
--
ALTER TABLE `prix_service`
  MODIFY `id_service` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `pwdresets`
--
ALTER TABLE `pwdresets`
...
--
-- AUTO_INCREMENT pour la table `vitals`
--
ALTER TABLE `vitals`
